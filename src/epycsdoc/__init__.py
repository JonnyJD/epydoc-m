...
interface (`epycsdoc.cli`) and a graphical interface (`epycsdoc.gui`).
...
.. digraph:: Overview of epycsdoc's architecture
   :caption: The boxes represent steps in epycsdoc's processing chain.
   ...
   */
   ...
   { /* Task collections */
     ...
     l3 -> l4 [label=" epycsdoc.\\l docbuilder.\\l build_doc_index()",
               href="<docbuilder.build_doc_index>"]
     l1 -> l2 [label=" epycsdoc.\\l cli()", href="<cli>"]
   }
...
====================
The epycsdoc package contains the following subpackages and modules:
...
epycsdoc is provided by `docbuilder`.  Docstring markup parsing is
...
"""The license governing the use and distribution of epycsdoc"""
