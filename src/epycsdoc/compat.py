# epycsdoc -- Backwards compatibility
#
...
Currently, epycsdoc requires Python 2.3+.
"""
...
# epycsdoc 3 would run under python 2.2.  However, I'm starting
# to think that it's not worth the trouble.  At the very least,
# epycsdoc's current unicode handling still doesn't work under
