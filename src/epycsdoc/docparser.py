...
import epycsdoc.docintrospecter
...
def parse_docs(filename=None, name=None, context=None, is_script=False):
    ...
    epycsdoc.docintrospecter.introspect_docs(__builtin__)
    epycsdoc.docintrospecter.introspect_docs(exceptions)
...
def lookup_name(identifier, parent_docs):
    ...
    # Builtins
    builtins = epycsdoc.docintrospecter.introspect_docs(__builtin__)
