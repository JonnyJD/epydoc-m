...
from epycsdoc.markup import epytext
from epycsdoc.apidoc import *
from epycsdoc.docintrospecter import introspect_docstring_lineno
from epycsdoc.util import py_src_filename
from epycsdoc import log
import epycsdoc.docparser
...
STANDARD_FIELDS = [
    #: A list of the standard simple fields accepted by epycsdoc.  This
...
def add_metadata_from_var(api_doc, field):
    for varname in field.varnames:
        ...
        # Try extracting the value from the parse tree.
            ...
            try: value = [epycsdoc.docparser.parse_string(val_doc.toktree)]
            except KeyboardInterrupt: raise
            except: pass
            if field.multivalue and not value:
                try: value = epycsdoc.docparser.parse_string_list(val_doc.toktree)
                except KeyboardInterrupt: raise
                except: pass
