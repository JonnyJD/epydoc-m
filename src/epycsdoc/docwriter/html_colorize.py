...
<?xml version="1.0" encoding="ascii"?>
        ...
        <head>
          ...
          <script type="text/javascript" src="epycsdoc.js"></script>
        </head>
...
if __name__=='__main__':
    #s = PythonSourceColorizer('../apidoc.py', 'epycsdoc.apidoc').colorize()
    s = PythonSourceColorizer('/tmp/fo.py', 'epycsdoc.apidoc').colorize()
    #print s
    import codecs
