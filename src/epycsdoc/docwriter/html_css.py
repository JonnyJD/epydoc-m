#
# epycsdoc.css: default epycsdoc CSS stylesheets
# Edward Loper
#
...
"""
Predefined CSS stylesheets for the HTML outputter (L{epycsdoc.docwriter.html}).
 ...
 *
 * This stylesheet can be used to customize the appearance of epycsdoc's
 * HTML output.
 *
 */
 ...
 *     docstring descriptions.  All headings used by epycsdoc itself use
 *     either class='epycsdoc' or class='toc' (CSS styles for both
 *     defined below).
 */
 ...
 *     pointer to epycsdoc's homepage.
 */
h1.epycsdoc                   { margin: 0; font-size: +140%; font-weight: bold; }
h2.epycsdoc                   { font-size: +130%; font-weight: bold; }
h3.epycsdoc                   { font-size: +115%; font-weight: bold;
                              margin-top: 0.2em; }
td h3.epycsdoc                { font-size: +115%; font-weight: bold;
                              margin-bottom: 0; }
