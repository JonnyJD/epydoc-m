#!/usr/bin/env python
#
# objdoc: epycsdoc command-line interface
# Edward Loper
#
...
"""
Graphical interface to epycsdoc.  This interface might be useful for
...
Usage::
    ...
    FILE.prj                  An epycsdoc GUI project file.
...
from epycsdoc.util import wordwrap
...
def document(options, cancel, done):
    ...
    import epycsdoc.docstringparser

    # Set the default docformat.
    docformat = options.get('docformat', 'epytext')
    epycsdoc.docstringparser.DEFAULT_DOCFORMAT = docformat
...
class EpydocGUI:
    """
    A graphical user interace to epycsdoc.
    """
    def __init__(self):
        self._afterid = 0
        self._progress = [None]
        ...
        # epycsdoc modules, Tkinter, pickle, and thread..
    ...
    def _init_options(self, optsframe, ctrlframe):
        ...
        from epycsdoc.docwriter.html_css import STYLESHEETS
    ...
    def add_module(self, name, check=0):
        from epycsdoc.util import is_package_dir, is_pyname, is_module_file
        from epycsdoc.docintrospecter import get_value_from_name
        from epycsdoc.docintrospecter import get_value_from_filename
...
def _version():
    ...
    """
    import epycsdoc
    print "Epydoc version %s" % epycsdoc.__version__
    sys.exit(0)
...
def _usage():
    ...
    print
    print '    FILE.prj                  An epycsdoc GUI project file.'
    print '    MODULES...                A list of Python modules to document.'
    print '    -V, --version             Print the version of epycsdoc.'
