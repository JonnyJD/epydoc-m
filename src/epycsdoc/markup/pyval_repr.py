# epycsdoc -- Marked-up Representations for Python Values
#
...
import types, re
import epycsdoc.apidoc
from epycsdoc.util import decode_with_backslashreplace
from epycsdoc.util import plaintext_to_html, plaintext_to_latex
from epycsdoc.compat import *
import sre_parse, sre_constants

from epycsdoc.markup.epytext import Element, ParsedEpytextDocstring
...
class PyvalColorizer:
    ...
    def colorize(self, pyval, parse_repr=None, min_score=None):
        ...
        """
        UNKNOWN = epycsdoc.apidoc.UNKNOWN
